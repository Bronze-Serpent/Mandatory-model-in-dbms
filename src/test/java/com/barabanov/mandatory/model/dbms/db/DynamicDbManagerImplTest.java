...
import com.barabanov.mandatory.model.dbms.dynamic.db.manager.DynamicDbManagerImpl;
...
public class DynamicDbManagerImplTest extends ContainerTestBase
{
    private final DynamicDbManagerImpl dynamicDbManager;
